...
@Component({
  selector: 'app-whatsapp-paylater-template',
  templateUrl: './whatsapp-paylater-template.component.html',
  styleUrls: ['./whatsapp-paylater-template.component.css']
})
export class WhatsappPaylaterTemplateComponent implements OnInit {
  bookingId: any;
  bookingdetails: any;
 booking: Booking;
