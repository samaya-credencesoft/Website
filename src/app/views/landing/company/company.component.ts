...
export class CompanyComponent implements OnInit {
  ...
  constructor( private meta:Meta) {
    ...
    this.meta.updateTag({property: 'og:image', content: 'https://uat.bookonepms.com/assets/images/lOGO_d/logo_white.png'})
    ...
    this.meta.updateTag({name: 'twitter:image', content: 'https://uat.bookonepms.com/assets/images/lOGO_d/logo_white.png'});
